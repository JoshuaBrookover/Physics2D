...
TestState::TestState() :
    ...
    circle1(CGUL::Vector2(100, 100), 40),
    circle2(CGUL::Vector2(100, 100), 40)
{
...
void TestState::Update(CGUL::Float32 deltaTime)
{
    ...
    circle1.position = stateMachine->GetMousePosition() + CGUL::Vector2(-100, 0);
    ...
    if (circle1.CollidingCircle(circle2))
    {
        circle1.color = CGUL::Colors::red;
        circle2.color = CGUL::Colors::red;
    }
    else
    {
        circle1.color = CGUL::Colors::cornflowerBlue;
        circle2.color = CGUL::Colors::cornflowerBlue;
    }
